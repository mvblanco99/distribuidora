							...
							<form>
								...
								<div style="display: flex; justify-content: center;">
									...
									<div class="form-group" style="margin-left:3px;">
										<p class="text-center">
											<div class="form-group" style="display: flex; justify-content: center;">
												<button class="btn btn-danger" id="btn_eliminar_categoria" style="font-family: OswaldLight; font-size: 17px;" type="button">
													Eliminar Categoría
												</button>
											</div>
										</p>
...
<?php 
    ...
    echo '<script src="views/js/modificar_categoria.js" type="module"></script>';
?>