...
<?php include "views/modules/page_content.php"?>
	...
	<div class="mdl-tabs__tab-bar">
		<a href="presentacion_productos" class="principal-tabs__a">Nueva Tipo de Presentación</a>
		<a href="lista_presentacion" class="principal-tabs__a active">Lista de Presentación</a>
	</div>
